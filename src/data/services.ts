...
export const servicesData: ServiceData[] = [
    {
        slug: 'wedding-bands',
        title: 'Luxury Wedding Bands',
        subtitle: 'Unforgettable Music for Your Special Day',
        description: 'Premier wedding bands in DC, Maryland, and Virginia. High-energy dance bands, jazz quartets, and ceremony strings.',
    ...
    },
    {
        ...
        description: 'Professional entertainment for corporate galas, awards dinners, and conferences in the DC metro area.',
    ...
    },
    {
        ...
        title: 'Private Party DJs',
        subtitle: 'The Perfect Vibe for Any Occasion',
        description: 'Top-rated DJs for private parties, birthdays, and anniversaries in Baltimore and DC.',
    ...
    {
        slug: 'jazz-ensembles',
        title: 'Jazz & Cocktail Music',
        subtitle: 'Sophisticated Atmosphere',
        description: 'Elegant jazz trios, quartets, and soloists for cocktail hours and dinner receptions.',
